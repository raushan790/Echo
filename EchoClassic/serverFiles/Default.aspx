...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <script>
        ...
        $.ajax({
            type: "POST",
            url: "http://echocommunicator.com/service1.svc/CreateAttendance",
            data: ss,
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" style="height: 100% auto; z-index: 100; margin-top: 97px;">
        <div class="row">
