<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Su-Dashboard.aspx.cs" Inherits="EchoClassic.Admin.Su_Dashboard" %>
            ...
            <div class="container body">
                <div class="main_container">
                    ...
                    <div class="" role="main" style="padding: 10px 20px 0; background-color: white;">
                                        ...
                                        <div class="row" align="center" style="height: 100px">
                                            <div id="divCountForDate" runat="server" class="row tile_count">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-xs-6">
                                                    <span class="count_top"><i class="fa fa-group"></i>Groups Reported</span>
                                                    <div class="count green" style="font-size: 30px; font-weight: bold; color: #228b22"><%=TotalClasses %></div>

                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i>Total Students</span>
                                                    <div class="count" style="font-size: 30px; font-weight: bold;"><%=TotalStudentsonDate %></div>
                                                    <span class="count_bottom">Present: <%=TotalStudentsPresentonDate %></span>
                                                </div>

                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i>Total Males</span>
                                                    <div class="count green" style="font-size: 30px; color: #002366"><%=TotalMaleonDate %></div>
                                                ...
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    ...
                                                    <div class="count" style="font-size: 30px; color: #e73895"><%=TotalFemaleonDate %></div>
                        ...
                        <%} else { Response.Write(DashbaordCode); }%>
                    </div>
