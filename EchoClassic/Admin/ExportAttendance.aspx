<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportAttendance.aspx.cs" Inherits="EchoClassic.Admin.ExportAttendance" %>
...
<head runat="server">
    ...
    <style>
        #gvCheckinCheckoutData > tbody > tr > td{
                            ...
                            <div class="container">
                                ...
                                <div id="navbar6" class="navbar-collapse collapse" style="background-color: #dedcdc;">
                                    <ul class="nav navbar-nav navbar-right" style="margin-left: 0px; position: relative; background-color: #e0e5e6; z-index: 1">
                                        ...
                                        <li class="active"><a href="#" style="font-weight: bold; background-color: #c7c2c2 !important">Export Attendance</a></li>
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    &nbsp;<asp:Button ID="Button1" Visible="false" runat="server" Text="Export to Excel" CssClass="btn btn-default btn-sm" OnClick="Button1_Click" />
                                                    &nbsp;<asp:Button ID="Button2" Visible="false" runat="server" Text="Export to Excel" CssClass="btn btn-default btn-sm" OnClick="Button2_Click" />
                    ...
                    <div class="row" style="overflow-y: scroll; max-height: 300px;">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                            ...
                            <asp:GridView ID="gvCheckinCheckoutData" runat="server" Style="box-shadow: 0px 1px 6px 1px; width: 100%"
                                ...
                                OnRowDataBound="gvCheckinCheckoutData_Databound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Image">
                                        <ItemTemplate>
                                            <asp:Image ID="imgUser" Width="80px" runat="server" ImageUrl='<%#Eval("ImageID","~/images/users/{0}") %>'></asp:Image>
                                        </ItemTemplate>
                                    </asp:TemplateField>
