<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Group-Dashboard.aspx.cs" Inherits="EchoClassic.Admin.Group_Dashboard" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <header style="background-color: white">
                <div class="row">
                    <div class="col-md-6">
                        <h1><asp:Literal ID="litSchoolName" runat="server"></asp:Literal></h1>
                    </div>
