<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="Invite.aspx.cs" Inherits="EchoClassic.Account.Invite" %>
    ...
    <div id="divFormSection" runat="server" class="form-horizontal">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control" Width="280px" ></asp:DropDownList>
