<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="EchoClassic.Admin.Dashboard" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="x_panel tile fixed_height_330 overflow_hidden">
                                    <div class="x_title">
                                        <h2>Top 5 Districts</h2>

                                        <div class="clearfix"></div>

                                    </div>
                                    <div id="divTopFive" runat="server" visible="false" class="col-md-12 col-sm-12 col-xs-6">
                                        <div>
                                            <p><%=Top1 %></p>
                                            <div class="">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="x_panel tile fixed_height_330">
                                    <div class="x_title">
                                        <h2>Bottom 5 Districts</h2>

                                        <div class="clearfix"></div>
                                    </div>
                                    <div id="divBottom5" runat="server" visible="false" class="col-md-12 col-sm-12 col-xs-6">
                                        <div>
                                            <p><%=Bottom1 %></p>
                                            <div class="">
                                                <div class="progress progress_sm" style="width: 76%;">
                                        ...
                                        <div>
                                            ...
                                            <div class="">
                                                <div class="progress progress_sm" style="width: 76%;">
                                                    <div class="progress-bar bg-red" role="progressbar" data-transitiongoal="90"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <ContentTemplate>
                                <div style="background: #fff;">
                                    <div class="row" style="overflow-y: scroll; max-height: 300px; padding-left: 10px;">
                                        ...
                                        --%>
                                        <h3>District</h3>
                                        <asp:GridView ID="gvDistrictLevel" runat="server"
                                            CssClass="table table-striped" AutoGenerateColumns="false" OnRowDataBound="gvDistrictLevel_Databound"
                                                ...
                                                <asp:TemplateField HeaderText="District">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="LinkDistrict" runat="server" CausesValidation="False"
                                                            CommandName="ViewDetails" Text='<%# Eval("PrimaryColoumn")%>'
                                                            CommandArgument='<%# Eval("PrimaryColoumn")%>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Attendance Teacher">
                                                    <ItemTemplate>
                                                        <div class="form-group row">
                                                            <div class="col-lg-3">
                                                                <b>Total:</b>
                                                                <asp:Label ID="lblTotalTeacherDistrict" Text='<%# Eval("TotalTeacher")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <b>Present:</b>
                                                                <asp:Label ID="lblTotalTeacherPresentDistrict" Text='<%# Eval("TotalTeacherPresent")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <b>Absent:</b>
                                                ...
                                                <asp:TemplateField HeaderText="Attendance Student">
                                                    <ItemTemplate>
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <b>Total:</b>
                                                                <asp:Label ID="lblTotalStudentBlock" Text='<%# Eval("TotalStudent")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Present:</b>
                                                                <asp:Label ID="lblTotalPresentBlock" Text='<%# Eval("TotalStudentPresent")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Absent:</b>
                                                                <asp:Label ID="lblTotalAbsentBlock" runat="server"></asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Percentage:</b>
                                                                <asp:Label ID="lblPercentageBlock" runat="server"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Attendance Teacher">
                                                    <ItemTemplate>
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <b>Total:</b>
                                                                <asp:Label ID="lblTotalTeacherBlock" Text='<%# Eval("TotalTeacher")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Present:</b>
                                                                <asp:Label ID="lblTotalTeacherPresentBlock" Text='<%# Eval("TotalTeacherPresent")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Absent:</b>
                                                                <asp:Label ID="lblTotalTeacherAbsentBlock" runat="server"></asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Percentage:</b>
                                                                <asp:Label ID="lblPercentageTeacherBlock" runat="server"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Attendance Student">
                                                    <ItemTemplate>
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <b>Total:</b>
                                                                <asp:Label ID="lblTotalStudentCluster" Text='<%# Eval("TotalStudent")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Present:</b>
                                                                <asp:Label ID="lblTotalPresentCluster" Text='<%# Eval("TotalStudentPresent")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Absent:</b>
                                                                <asp:Label ID="lblTotalAbsentCluster" runat="server"></asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Percentage:</b>
                                                                <asp:Label ID="lblPercentageCluster" runat="server"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Attendance Teacher">
                                                    <ItemTemplate>
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <b>Total:</b>
                                                                <asp:Label ID="lblTotalTeacherCluster" Text='<%# Eval("TotalTeacher")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Present:</b>
                                                                <asp:Label ID="lblTotalTeacherPresentCluster" Text='<%# Eval("TotalTeacherPresent")%>' runat="server">
                                                                </asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Absent:</b>
                                                                <asp:Label ID="lblTotalTeacherAbsentCluster" runat="server"></asp:Label>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <b>Percentage:</b>
                                                                <asp:Label ID="lblPercentageTeacherCluster" runat="server"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="School">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="LinkSchool" runat="server" CausesValidation="False"
                                                            CommandName="ViewDetails" Text='<%# Eval("GroupName")%>'
                                                            CommandArgument='<%# Eval("GroupName")%>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Attendance Student">
                                                    <ItemTemplate>
