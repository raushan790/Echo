...
public class General : System.Web.UI.Page
{
    ...
    public static string SendPushDataAndroid(string DeviceToken, dynamic Data)
    {
    ...
    public static string GetImage(bool allowed)
    {
        if (allowed)
            return "~/App_Themes/Admin/Images/active.gif";
        else
            return "~/App_Themes/Admin/Images/deactive.gif";
    }
    ...
    public static int QueryStringEncInt(string Name)
    {
        string resultStr = Encryption.Decrypt(QueryString(Name));
        int result;
        Int32.TryParse(resultStr, out result);
        return result;
    }
    ...
    public static string GetCurrentPageName(string _URL)
    {
        System.IO.FileInfo oInfo = new System.IO.FileInfo(_URL);
    ...
    public static void FillDropDownWithEnum(DropDownList List, Type enumType)
    {
        ...
        foreach (string str2 in strArray)
        {
            ...
            ListItem ddlItem = new ListItem(General.ConvertEnum(str2), enumValue.ToString());
    ...
    public static void SendSMS(string mobile, string message)
    {
        ...
        {
            ShowAlertMessage("SMS could not be sent!");
        }
    }
    ...
    public static string OrderStatusCode(string StrStatusID)
    {
        if (StrStatusID == "1")
            return "Payment Received";
        else if (StrStatusID == "0")
            return "Payment Not Received";
        else
            return "";
    }

    public static void EmptyTextBoxes(System.Web.UI.Control parent)
    {
    ...
    public static void ShowAlertMessage(string error, string redirectUrl)
    {
        System.Web.UI.Page page = HttpContext.Current.Handler as System.Web.UI.Page;
        if (page != null)
        {
            error = error.Replace("'", "\'");
            System.Web.UI.ScriptManager.RegisterStartupScript(page, page.GetType(), "err_msg", "alert('" + error + "');location.href='" + redirectUrl + "'", true);
        }
    }
