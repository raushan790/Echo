...
namespace EchoClassic.Account
{
    public partial class ManageGroups : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Context.User.Identity.Name.ToUpper() == "E1BB3A61-5BAB-4B36-88AB-5C4920D57828")
                {
                ...
                if (GroupID > 0)
                {
                   ...
                   bool isadminchk= u.UserGroup.Where(ss => ss.UserGroupID == GroupID).FirstOrDefault().isAdmin;

                    if (type != "1"||!isadminchk)
                    {
                ...
                else
                {
                    ...
                    if (isValidUser())
                    {
                        ...
                        else
                        {
                            ...
                            u.IsDeleted = false;
                            u.IsLockedOut = !chkIsAdmin.Checked;
                            u.RoleID = 4;
