<%@ Page Title="Mark Attendance" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="SelfAttendanceType4.aspx.cs" Inherits="EchoClassic.Account.SelfAttendanceType4" %>
                    ...
                    <div id="Attendance" class="tab-pane fade in active">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <asp:Literal ID="litAttCount" runat="server" Visible="false" Text="0"></asp:Literal>
