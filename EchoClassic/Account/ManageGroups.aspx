<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="ManageGroups.aspx.cs" Inherits="EchoClassic.Account.ManageGroups" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <%--<div id="flip1" style="font-weight: bold">
                        <i class="fa fa-laptop" style="font-size: 16px"></i>&nbsp View Attendance
                    </div>
                    <div id="panel1">
                        <label>Choose Date:</label>
                        <asp:TextBox ID="datepicker" runat="server"></asp:TextBox>
                        <asp:GridView ID="gvGroupAttendance" runat="server" CssClass="table table-striped" AutoGenerateColumns="false">
                            <Columns>
                                <asp:BoundField HeaderText="Name" DataField="FirstName" />
                                <asp:BoundField HeaderText="Attendance Status" DataField="AttendanceStatus" />
                            </Columns>
                        </asp:GridView>
                    </div>--%>
                        </div>
