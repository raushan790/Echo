<%@ Page Title="Manage Group" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="ManageGroupsType2.aspx.cs" Inherits="EchoClassic.Account.ManageGroupsType2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="tab-content">
        ...
        <div id="Attendance" class="tab-pane fade in active">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <asp:Timer ID="AttendanceTimer" runat="server" Interval="1000"
                        OnTick="TimerTick" Enabled="false">
                    </asp:Timer>
                    ...
                    <asp:Panel ID="pnlAttendance" runat="server" Width="99%">
                        <asp:UpdatePanel ID="up2" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                ...
                                <h2>
                                    <asp:Literal ID="litAttendanceCode" runat="server"> </asp:Literal>
                                    <asp:Literal ID="litTimer" runat="server"> </asp:Literal>
                                </h2>

                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="AttendanceTimer" EventName="Tick" />
                            </Triggers>
                        </asp:UpdatePanel>
                        <asp:GridView ID="gvAttendance" runat="server" CssClass="table table-striped" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Attendance" ItemStyle-Width="50%">
                                    <ItemTemplate>
                                        <asp:RadioButton ID="rbPresent" runat="server" Text="Present" GroupName="grpAttendance"></asp:RadioButton>
                                        <asp:RadioButton ID="rbAbsent" runat="server" Text="Absent" GroupName="grpAttendance" Checked="true"></asp:RadioButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
        ...
        <div id="Notice" class="tab-pane fade">
          <asp:GridView ID="gvNotice" runat="server" CssClass="table table-striped" 
