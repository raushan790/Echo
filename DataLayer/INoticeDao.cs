...
namespace DataObjects
{
    public interface INoticeDao
    {
        ...
        int CreateNotice(int GroupID, System.Collections.Generic.IList<string>UserIDs,string NoticeTitle, string NoticeDetail,string Createdby, DateTime NoticeDate,string FileName,int FileType=0,int ParentId=0, int IsSms=0, int IsReply=0);
